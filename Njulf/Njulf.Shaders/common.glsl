...
const int FAR_FIELD_CLIPMAP_PARAMS_BUFFER_INDEX = 173;
const int FAR_FIELD_CLIPMAP_VOXEL_BUFFER_INDEX = 174;
const int FAR_FIELD_CLIPMAP_INSTANCE_BUFFER_INDEX = 175;
const int FAR_FIELD_CLIPMAP_BAKE_VOXEL_BUFFER_INDEX = 176;
const int STATIC_BUFFER_COUNT = 177;
...
const uint DDGI_INVESTIGATION_COUNTER_BASE = FAR_FIELD_COUNTER_BASE + 5u;
