...
internal sealed class SampleDiagnosticsReporter
{
    ...
    public void PrintFirstFrameDiagnostics(IRenderer renderer)
    {
        ...
        Console.WriteLine(
            $"Frame diagnostics mesh shader: requested={diagnostics.MeshShaderRequestedMode}, selected={diagnostics.MeshShaderSelectedMode}, taskless={diagnostics.MeshShaderTaskless}, " +
            $"contract={diagnostics.MeshShaderMaximumVertices}v/{diagnostics.MeshShaderMaximumPrimitives}p/{diagnostics.MeshShaderWorkgroupSize}t, fallback='{diagnostics.MeshShaderFallbackReason}', " +
            $"deviceLimits={diagnostics.DeviceMaximumMeshOutputVertices}v/{diagnostics.DeviceMaximumMeshOutputPrimitives}p/{diagnostics.DeviceMaximumMeshWorkgroupInvocations}t, " +
            $"preferences=localV:{diagnostics.DevicePrefersLocalInvocationVertexOutput},localP:{diagnostics.DevicePrefersLocalInvocationPrimitiveOutput},compactV:{diagnostics.DevicePrefersCompactVertexOutput},compactP:{diagnostics.DevicePrefersCompactPrimitiveOutput}.");
        Console.WriteLine(
            $"Frame diagnostics meshlet residency: configured={diagnostics.MeshletPhysicalResidencyConfigured}, available={diagnostics.MeshletPhysicalResidencyAvailable}, active={diagnostics.MeshletPhysicalResidencyActive}, degraded={diagnostics.MeshletPhysicalResidencyDegraded}, reloadRequired={diagnostics.MeshletPhysicalResidencyReloadRequired}, " +
            $"packages={diagnostics.MeshletPhysicalResidencyActivePackageCount}/{diagnostics.MeshletPhysicalResidencyFallbackPackageCount}, submeshes={diagnostics.MeshletPhysicalResidencyActiveSubMeshCount}, pages=pinned:{diagnostics.MeshletPhysicalResidencyPinnedResidentPageCount}/{diagnostics.MeshletPhysicalResidencyPinnedPageCount},resident:{diagnostics.MeshletPhysicalResidencyResidentPageCount},queued:{diagnostics.MeshletPhysicalResidencyQueuedPageCount},reading:{diagnostics.MeshletPhysicalResidencyReadingPageCount},uploading:{diagnostics.MeshletPhysicalResidencyUploadingPageCount},failed:{diagnostics.MeshletPhysicalResidencyFailedPageCount},retired:{diagnostics.MeshletPhysicalResidencyRetiredPageCount}, " +
            $"banks={diagnostics.MeshletPhysicalResidencyAllocatedBankCount}, committedMiB={diagnostics.MeshletPhysicalResidencyCommittedBytes / (1024.0 * 1024.0):F1}, demands={diagnostics.MeshletPhysicalResidencyDemandKeyCount}, overflow={diagnostics.MeshletPhysicalResidencyRequestOverflowCount}, hit={diagnostics.MeshletPhysicalResidencyHitRate:P1}, fallback={diagnostics.MeshletPhysicalResidencyFallbackRate:P1}, uploadedMiB={diagnostics.MeshletPhysicalResidencyUploadedBytes / (1024.0 * 1024.0):F1}, invalidMappings={diagnostics.MeshletPhysicalResidencyInvalidMappingCount}, fallbackReasons='{diagnostics.MeshletPhysicalResidencyFallbackReasonSummary}', latestFailure='{diagnostics.MeshletPhysicalResidencyLatestFailure}'.");
        Console.WriteLine(
