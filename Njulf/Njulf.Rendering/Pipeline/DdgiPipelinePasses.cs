    ...
    public abstract unsafe class DdgiComputePass : RenderPassBase
    {
        ...
        private GPUDdgiUpdatePushConstants CreatePushConstants(SceneRenderingData sceneData)
        {
            ...
            return new GPUDdgiUpdatePushConstants
            {
                ...
                SurfaceCardBufferIndex = BindlessIndex.SurfaceCacheCardBuffer,
                SurfaceCardCount = checked((uint)Math.Max(0, sceneData.SurfaceCacheCardCount)),
                SurfaceRadianceAtlasTextureIndex = BindlessIndex.SurfaceCacheRadianceAtlasTexture,
                GlobalSdfCascadeBufferIndex = BindlessIndex.GlobalSdfCascadeBuffer,
                GlobalSdfCascadeCount = checked((uint)Math.Max(0, sceneData.GlobalSdfCascadeCount)),
