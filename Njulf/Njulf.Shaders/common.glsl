...
const int DDGI_SCHEDULER_CONSTANTS_BUFFER_INDEX = 146;
const int DDGI_DIRTY_REGION_BUFFER_INDEX = 147;
const int DDGI_PROBE_CANDIDATE_BUFFER_INDEX = 148;
const int DDGI_SCHEDULER_GROUP_COUNT_BUFFER_INDEX = 149;
const int DDGI_SCHEDULER_PREFIX_BUFFER_INDEX = 150;
const int DDGI_SCHEDULER_COUNTER_BUFFER_INDEX = 151;
const int DDGI_TRACE_INDIRECT_DISPATCH_BUFFER_INDEX = 152;
const int STATIC_BUFFER_COUNT = 153;
