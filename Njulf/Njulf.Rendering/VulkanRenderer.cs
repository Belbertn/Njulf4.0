...
namespace Njulf.Rendering
{
    ...
    public unsafe class VulkanRenderer : IRenderer, IRendererDebugTools, IDisposable
    {
        ...
        public void RequestGlobalSdfFullRedirty()
        {
            _globalSdfManager?.MarkAllCascadesDirty();
        }
        ...
        private RendererDiagnostics BuildDiagnostics(SceneRenderingData sceneData)
        {
                ...
                GpuReflectionProbePrefilterMicroseconds: sceneData.GpuReflectionProbePrefilterMicroseconds)
            {
                ...
                GlobalSdfScrollChangedBrickValidationFailureCount = giUsesDdgi ? sceneData.GlobalSdfScrollChangedBrickValidationFailureCount : 0,
                ...
                GlobalSdfCascades = giUsesDdgi ? sceneData.GlobalSdfCascadeDiagnostics.ToArray() : Array.Empty<GlobalSdfCascadeDiagnosticsEntry>(),
