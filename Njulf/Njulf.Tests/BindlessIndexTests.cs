...
public sealed class BindlessIndexTests
{
    ...
    public void ShaderConstants_MatchCurrentSimpleDdgiContract()
    {
        IReadOnlyDictionary<string, int> expected = new Dictionary<string, int>
        {
            ...
            ["SIMPLE_DDGI_MASKED_FEEDBACK_COMPACT_BUFFER_BASE_INDEX"] = BindlessIndex.SimpleDdgiMaskedFeedbackCompactBufferBase,
            ...
            ["GTAO_REFERENCE_NORMAL_TEXTURE_INDEX"] = BindlessIndex.GtaoReferenceNormalTexture,
