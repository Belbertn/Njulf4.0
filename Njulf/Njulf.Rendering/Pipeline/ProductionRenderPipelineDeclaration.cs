...
internal sealed class ProductionRenderPipelineDeclaration
{
    ...
    public IReadOnlyList<RenderGraphPassResourceDeclaration> CreatePassResourceDeclarations(bool includeSsgi)
    {
        ...
        declarations.AddRange([
            Pass("MeshSdfBakePass",
                Read(RenderGraphResourceId.SceneSubmissionBuffers),
                ReadWriteComputeStorage(RenderGraphResourceId.GlobalSdfResources)),
            Pass("GlobalSdfPass",
                Read(RenderGraphResourceId.SceneSubmissionBuffers),
                ReadWriteComputeStorage(RenderGraphResourceId.GlobalSdfResources)),
            Pass("SurfaceCachePass",
                Read(RenderGraphResourceId.SceneSubmissionBuffers),
                ReadWriteComputeStorage(RenderGraphResourceId.SurfaceCacheResources)),
        ...
        bool includeSsgi)
    {
        ...
        [
            ...
            OwnedImageResource(RenderGraphResourceId.GlobalSdfResources, "Global SDF clipmap volumes", Format.R16Sfloat, RenderGraphResourceSizePolicy.Fixed),
            OwnedImageResource(RenderGraphResourceId.SurfaceCacheResources, "Surface cache atlases", RenderTargetManager.SceneColorFormat, RenderGraphResourceSizePolicy.Fixed),
