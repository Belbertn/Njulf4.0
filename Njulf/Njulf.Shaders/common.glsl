...
const uint DDGI_DELIVERY_FAILURE_COUNTER_BASE = 292u;
const uint DDGI_HIGH_OWNERSHIP_LOW_DELIVERED_INDIRECT_COUNTER =
    DDGI_DELIVERY_FAILURE_COUNTER_BASE + 0u;
const uint DDGI_SHADOW_VISIBILITY_COUNTER_BASE = 293u;
...
// Appended after the 16 per-volume energy banks (321 + 16 * 19).
// Every albedo class is a packed luminance sum followed by a sample count.
const uint DDGI_ALBEDO_COUNTER_BASE = 625u;
