...
namespace Njulf.Core.Scene
{
    public class Model : IDisposable
    {
        ...
        {
            if (this is ModelInstance { AttachedScene: not null })
                throw new InvalidOperationException("Detach the model instance before changing its structure or disposing it.");
        }
        ...
        public RenderObject CreateRenderObjectInstance(int renderObjectIndex)
        {
            ...
            try
            {
                ...
                try { clone.Material = source.Material; }
                ...
                clone.LocalMeshBounds = source.LocalMeshBounds;
                return clone;
            }
