...
internal sealed class SampleDiagnosticsReporter
{
    ...
    private static void PrintSdfDiagnostics(RendererDiagnostics diagnostics)
    {
        Console.WriteLine(
            ...
            $"bricks={diagnostics.GlobalSdfBricksUpdated}, priority/dirty/idleRefreshExecuted={diagnostics.GlobalSdfPriorityBricksUpdated}/{diagnostics.GlobalSdfDirtyBricksUpdated}/{diagnostics.GlobalSdfIdleRefreshBricksUpdated}, budget={diagnostics.GlobalSdfBrickUpdateBudget}, backlog={diagnostics.GlobalSdfDirtyBrickBacklog}, " +
            $"scrollDeltaCells={diagnostics.GlobalSdfScrollDeltaCells} (c0={diagnostics.GlobalSdfCascade0ScrollDeltaCells}), scrollInvalidated={diagnostics.GlobalSdfScrollInvalidatedBricks} (c0={diagnostics.GlobalSdfCascade0ScrollInvalidatedBricks}), " +
            $"meshSdfs={diagnostics.GlobalSdfMeshSdfCount}, bakedMeshes/pendingBakes={diagnostics.MeshSdfBakedMeshCount}/{diagnostics.MeshSdfPendingBakeCount}, skippedInstances={diagnostics.MeshSdfSkippedInstanceSdfCount}, overflow={diagnostics.GlobalSdfCandidateOverflowCount}, emptyPrevCandidateBricks={diagnostics.GlobalSdfEmptyPreviouslyCandidateBrickCount}, bricksWrittenEmpty/withCandidates={diagnostics.GlobalSdfBricksWrittenEmptyCount}/{diagnostics.GlobalSdfBricksWrittenWithCandidatesCount}, " +
    ...
    private static void PrintDdgiTriageDiagnostics(RendererDiagnostics diagnostics)
    {
        ...
        Console.WriteLine(
            ...
            $"sdfBricks={diagnostics.GlobalSdfBricksUpdated} priority/dirty/idleRefreshExecuted={diagnostics.GlobalSdfPriorityBricksUpdated}/{diagnostics.GlobalSdfDirtyBricksUpdated}/{diagnostics.GlobalSdfIdleRefreshBricksUpdated} (budget={diagnostics.GlobalSdfBrickUpdateBudget} backlog={diagnostics.GlobalSdfDirtyBrickBacklog}) meshSdfs={diagnostics.GlobalSdfMeshSdfCount} overflow={diagnostics.GlobalSdfCandidateOverflowCount} emptyPrevCandidateBricks={diagnostics.GlobalSdfEmptyPreviouslyCandidateBrickCount} sdfSteps={diagnostics.GlobalSdfAverageTraceSteps:F2} sdfTraces={diagnostics.DdgiSdfTraceCount} rayQueryTraces={diagnostics.DdgiRayQueryTraceCount} " +
            $"sdfInsideStarts={diagnostics.DdgiSdfInsideStartCount} sdfBackfaceSynthesized={diagnostics.DdgiSdfBackfaceSynthesizedCount} sdfStepExhausted={diagnostics.DdgiSdfStepExhaustedCount} sdfCoarseSkips={diagnostics.DdgiSdfCoarseSkipCount} " +
            $"cacheTiles={diagnostics.SurfaceCacheTilesCaptured} cacheLookups={diagnostics.DdgiSurfaceCacheLookupCount} cacheFallback%={diagnostics.DdgiSurfaceCacheFallbackPercent:F2} cacheFallbackBackend={diagnostics.DdgiSurfaceCacheFallbackSdfCount}/{diagnostics.DdgiSurfaceCacheFallbackRayQueryCount} " +
            $"cacheReject={diagnostics.DdgiSurfaceCacheRejectGridMissCount}/{diagnostics.DdgiSurfaceCacheRejectDepthUvCount}/{diagnostics.DdgiSurfaceCacheRejectNormalAxisCount}/{diagnostics.DdgiSurfaceCacheRejectAlphaTexelCount}/{diagnostics.DdgiSurfaceCacheRejectNoCandidatePassedCount} candidate={diagnostics.DdgiSurfaceCacheCandidateCellsEmptyCount}/{diagnostics.DdgiSurfaceCacheCandidateRefsSeenCount}/{diagnostics.DdgiSurfaceCacheCandidateRefsInvalidCount}/{diagnostics.DdgiSurfaceCacheCandidateRefsProjectedRejectedCount} atlasOccupancy={diagnostics.SurfaceCacheOccupancyPermille / 10.0f:F1}% " +
