...
public sealed class OpticalDenoisingSettings
{
    ...
    public bool CompactLayers { get; set; } = true;
    /// <summary>Shade selected compact layers after native surface export.</summary>
    public bool ReducedResolutionShading { get; set; } = true;
