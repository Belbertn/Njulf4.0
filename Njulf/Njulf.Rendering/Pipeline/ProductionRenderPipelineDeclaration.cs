...
internal sealed class ProductionRenderPipelineDeclaration
{
        ...
        bool depthMotionFusion)
    {
        var declarations = new List<RenderGraphPassResourceDeclaration>
        {
            ...
            Pass("AreaShadowDenoisePass",
                ReadComputeDepth(RenderGraphResourceId.SceneDepth),
                ReadComputeSampled(RenderGraphResourceId.MotionVectors),
                ReadWriteComputeBuffer(RenderGraphResourceId.AreaRayShadowMask)),
        ...
        declarations.AddRange([
            ...
            Pass("GtaoSpatialPass",
                ...
                WriteComputeStorage(RenderGraphResourceId.GtaoFiltered,
                    ImageLayout.ShaderReadOnlyOptimal),
                WriteComputeStorage(RenderGraphResourceId.GtaoReferenceNormal,
                    ImageLayout.ShaderReadOnlyOptimal),
        ...
        declarations.Add(
            Pass("ForwardPlusPass",
                ...
                ReadFragmentSampled(RenderGraphResourceId.GtaoReferenceNormal),
        ...
        declarations.AddRange([
            ...
            Pass("AutomaticPlanarReflectionPass",
                Read(RenderGraphResourceId.SceneSubmissionBuffers),
                Read(RenderGraphResourceId.FoliageBuffers),
                ReadGraphicsStorage(RenderGraphResourceId.MeshGeometryBuffers),
                ReadGraphicsStorage(RenderGraphResourceId.MaterialBuffers),
                ...
                ReadGraphicsStorage(RenderGraphResourceId.SimpleDdgiDirectionalRadiance),
                ...
                ReadWriteGraphicsStorage(RenderGraphResourceId.AutomaticPlanarReflections)),
            Pass("HybridReflectionClassifyPass",
                ReadComputeSampled(
                    RenderGraphResourceId.HybridReflectionReceiverPayload),
                ReadComputeSampled(RenderGraphResourceId.MotionVectors),
                ReadComputeStorage(
            ...
            Pass("HybridReflectionSsrPass",
                ...
                ReadWriteComputeStorage(
                    RenderGraphResourceId.BloomChain,
                    ImageLayout.ShaderReadOnlyOptimal),
                ReadComputeDepth(RenderGraphResourceId.SceneDepth),
                ReadComputeSampled(RenderGraphResourceId.HiZPyramid),
                ReadComputeSampled(
            ...
            Pass("HybridReflectionResolvePass",
                ...
                ReadComputeBuffer(RenderGraphResourceId.AutomaticPlanarReflections),
                ReadComputeStorage(
                    RenderGraphResourceId.HybridReflectionHistory,
                    RenderGraphHistoryBindingSelection.Current),
                ReadWriteComputeStorage(
            ...
            Pass("HybridReflectionTemporalPass",
                ...
                ReadComputeStorage(RenderGraphResourceId.HybridReflectionHistory,
                    RenderGraphHistoryBindingSelection.Previous, sampledAlias: true),
            ...
            Pass("OpaqueSceneColorSnapshotPass",
                ...
                WriteComputeStorage(
                    ...
                    historyBinding:
                        RenderGraphHistoryBindingSelection.Previous)),
            Pass("OpticalLayerClearPass", WriteTransferAndComputeBuffer(RenderGraphResourceId.OpticalLayers)),
            Pass("TransparentForwardPass",
                ReadWriteGraphicsStorage(RenderGraphResourceId.OpticalLayers),
                ReadDepth(RenderGraphResourceId.SceneDepth),
                ReadFragmentSampled(
                    RenderGraphResourceId.HybridReflectionHistory,
                    RenderGraphHistoryBindingSelection.Previous),
                ...
                Read(RenderGraphResourceId.PointShadowCubemapArray),
                Read(RenderGraphResourceId.ReflectionProbeCubemaps),
                ReadGraphicsStorage(RenderGraphResourceId.AutomaticPlanarReflections),
                ReadFragmentSampled(RenderGraphResourceId.EnvironmentMaps),
                ReadGraphicsStorage(RenderGraphResourceId.MeshGeometryBuffers),
                ReadGraphicsStorage(RenderGraphResourceId.MaterialBuffers),
                ReadFragmentSampled(RenderGraphResourceId.MaterialTextures),
            ...
            Pass("OpticalTemporalPass",
                ReadWriteComputeBuffer(RenderGraphResourceId.OpticalLayers),
                ReadComputeBuffer(RenderGraphResourceId.SimpleDdgiParameters),
                ReadComputeAccelerationStructure(RenderGraphResourceId.TlasStorage),
                ReadComputeBuffer(RenderGraphResourceId.RayQueryInstanceMetadata),
                ReadComputeBuffer(RenderGraphResourceId.MeshGeometryBuffers),
                ...
                ReadComputeDepth(RenderGraphResourceId.SceneDepth),
                ReadComputeSampled(RenderGraphResourceId.HiZPyramid),
                ReadComputeSampled(RenderGraphResourceId.BloomChain),
                ReadComputeSampled(RenderGraphResourceId.HybridReflectionHistory, RenderGraphHistoryBindingSelection.Previous),
                ...
                ReadComputeBuffer(RenderGraphResourceId.DirectionalRayShadowMask),
                ReadComputeBuffer(RenderGraphResourceId.AreaRayShadowMask),
                ReadComputeBuffer(RenderGraphResourceId.DirectionalShadowHistory),
                ReadComputeBuffer(RenderGraphResourceId.DirectionalShadowDiagnostics),
                ReadWriteComputeBuffer(RenderGraphResourceId.DirectionalShadowCounters),
                ReadComputeBuffer(RenderGraphResourceId.SimpleDdgiIrradianceAtlas),
                ReadComputeBuffer(RenderGraphResourceId.SimpleDdgiVisibilityAtlas),
                ReadComputeBuffer(RenderGraphResourceId.SimpleDdgiReceiverProbes),
                ...
                ReadWriteComputeBuffer(RenderGraphResourceId.SimpleDdgiScheduler),
                ReadWriteComputeBuffer(RenderGraphResourceId.RendererDiagnosticsBuffer)),
            Pass("OpticalSpatialPass", ReadWriteComputeBuffer(RenderGraphResourceId.OpticalLayers)),
            Pass("OpticalCorrectionPass",
                ReadWriteComputeBuffer(RenderGraphResourceId.OpticalLayers),
                ReadWriteComputeStorage(RenderGraphResourceId.SceneColor, ImageLayout.ColorAttachmentOptimal),
                ReadWriteComputeStorage(RenderGraphResourceId.WeightedOitAccumulation, ImageLayout.ShaderReadOnlyOptimal)),
        ...
        Format swapchainColorFormat)
    {
        ...
        [
            ...
            OwnedImageResource(RenderGraphResourceId.GtaoCurrentGeometry,
            ...
            OwnedImageResource(RenderGraphResourceId.GtaoFiltered,
                ...
                RenderTargetManager.GtaoRadianceFormat,
                RenderGraphResourceSizePolicy.SceneResolution),
            OwnedImageResource(RenderGraphResourceId.GtaoReferenceNormal,
                "GTAO reference normal",
                RenderTargetManager.GtaoReferenceNormalFormat,
                RenderGraphResourceSizePolicy.SceneResolution),
            ...
            BufferSetResource(RenderGraphResourceId.OpticalLayers, "Transparent optical layers and history"),
            ...
            BufferSetResource(RenderGraphResourceId.TemporalSurfaceValidityHistory,
                "Shared temporal surface validity history"),
            ...
            BufferSetResource(
                RenderGraphResourceId.HybridReflectionTileScheduler,
                "Hybrid reflection adaptive tile scheduler"),
            ...
            new RenderGraphResourceDescriptor(
                RenderGraphResourceId.AutomaticPlanarReflections,
                "Automatic planar reflection captures and metadata",
    ...
    private static RenderGraphResourceUsage ReadFragmentSampled(
    ...
    private static RenderGraphResourceUsage ReadComputeStorage(
        ...
        RenderGraphHistoryBindingSelection historyBinding =
            RenderGraphHistoryBindingSelection.All,
        bool sampledAlias = false)
    {
        return new RenderGraphResourceUsage(
            resource,
            RenderGraphResourceAccess.Read,
            PipelineStageFlags2.ComputeShaderBit,
            AccessFlags2.ShaderStorageReadBit | (sampledAlias ? AccessFlags2.ShaderSampledReadBit : AccessFlags2.None),
            ImageLayout.General,
            RenderGraphQueueIntent.Compute,
            HistoryBinding: historyBinding);
    }
