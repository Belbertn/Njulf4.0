...
namespace Njulf.Rendering.Pipeline
{
    ...
    public abstract unsafe class DdgiComputePass : RenderPassBase
    {
        ...
        {
            GlobalIlluminationSettings gi = _settings.GlobalIllumination;
            // Probe-ray misses must see the same radiance scale as the visible
            // sky. DiffuseIntensity is reserved for the forward ambient-IBL
            // complement and is deliberately allowed to differ.
