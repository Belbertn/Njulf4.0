...
namespace Njulf.Rendering.Pipeline
{
    public sealed unsafe class WeightedOitCompositePass : RenderPassBase
    {
        ...
        public WeightedOitCompositePass(
            ...
            WeightedOitCompositePipeline pipeline,
        ...
        public override void Execute(CommandBuffer cmd, int frameIndex, SceneRenderingData sceneData)
        {
            ...
            _renderTargets.WeightedOitAccumulation.TransitionToShaderRead(cmd);
            _renderTargets.WeightedOitRevealage.TransitionToShaderRead(cmd);
            ...
            var pushConstants = new GPUWeightedOitCompositePushConstants
            {
                ...
                DebugView = (uint)sceneData.TransparencyDebugView
            };

            uint size = (uint)Marshal.SizeOf<GPUWeightedOitCompositePushConstants>();
