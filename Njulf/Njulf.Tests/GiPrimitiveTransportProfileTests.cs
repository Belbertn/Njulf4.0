...
public sealed class GiPrimitiveTransportProfileTests
{
    ...
    public void Generator_AppliesStandaloneIorWithoutTransmissionAndHashesTheAuthoredValue()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(GiPrimitiveTransportProfile.CurrentAlgorithmVersion, Is.EqualTo(4u));
            Assert.That(high.AlgorithmVersion, Is.EqualTo(4u));
        });
    }
    ...
    public void MaterialPackage_RejectsPreviousHemisphericalTransportAlgorithm()
    {
        ...
        Assert.That(
            ...
            Throws.TypeOf<InvalidDataException>()
                .With.Message.Contains("declares primitive algorithm 2, expected 4"));
