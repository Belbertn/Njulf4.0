...
const int SIMPLE_DDGI_MASKED_FEEDBACK_COMPACT_BUFFER_BASE_INDEX = 777;
const int SIMPLE_DDGI_MASKED_FEEDBACK_COMPACT_BUFFER_FRAME1_INDEX = 778;
const int HYBRID_REFLECTION_SPARSE_LOBE_BUFFER_BASE_INDEX = 779;
const int HYBRID_REFLECTION_SPARSE_LOBE_BUFFER_FRAME1_INDEX = 780;
const int TEMPORAL_SURFACE_VALIDITY_BUFFER_BASE_INDEX = 781;
const int TEMPORAL_SURFACE_VALIDITY_BUFFER_FRAME1_INDEX = 782;
const int OPTICAL_LAYER_BUFFER_BASE_INDEX = 783;
const int OPTICAL_LAYER_BUFFER_FRAME1_INDEX = 784;
const int AMD_SHADOW_BUFFER_BASE_INDEX = 785;
const int AMD_REFLECTION_BUFFER_BASE_INDEX = 793;
const int OPTICAL_COMPACT_BUFFER_BASE_INDEX = 795;
const int STATIC_BUFFER_COUNT = 797;
const uint GPU_PARTICLE_BLEND_BUCKET_COUNT = 5u;
const uint GPU_PARTICLE_WORKGROUP_SIZE = 256u;
const uint GPU_PARTICLE_INDIRECT_ACTIVE_LIST_WORD = 20u;
const uint GPU_PARTICLE_INDIRECT_NEXT_ALIVE_COUNT_WORD = 21u;
const uint GPU_PARTICLE_INDIRECT_CURRENT_ALIVE_COUNT_WORD = 22u;
const uint GPU_PARTICLE_INDIRECT_UPDATE_DISPATCH_WORD = 24u;
const uint GPU_PARTICLE_INDIRECT_EMIT_DISPATCH_WORD = 28u;
const uint GPU_PARTICLE_INDIRECT_SORT_WORK_BASE_WORD = 32u;
const uint GPU_PARTICLE_INDIRECT_SORT_PREFIX_BASE_WORD = 44u;
const uint GPU_PARTICLE_INDIRECT_DISPATCH_WORD_STRIDE = 4u;
const uint GPU_PARTICLE_INDIRECT_TOTAL_WORD_COUNT = 56u;
...
const int TAA_HISTORY_TEXTURE_B_INDEX = 301;
const int OPAQUE_SCENE_COLOR_SNAPSHOT_TEXTURE_B_INDEX = 302;
const int GTAO_REFERENCE_NORMAL_TEXTURE_INDEX = 303;
const int FIRST_DYNAMIC_TEXTURE_INDEX = 304;
...
const int SIZEOF_GPU_MOTION_VECTOR_PUSH_CONSTANTS = 224;
...
const int SIZEOF_GPU_ANTI_ALIASING_PUSH_CONSTANTS = 128;
...
// Plan-4 feasibility evidence. These counters are populated only by the
// explicitly selected receiver-cache qualification artifact, never by the
// production Forward programs.
const uint COMMON_SURFACE_SIMPLE_OPAQUE_PIXEL_COUNTER =
    SIMPLE_DDGI_RECEIVER_CACHE_COUNTER_BASE + 18u;
const uint COMMON_SURFACE_ELIGIBLE_PIXEL_COUNTER =
    SIMPLE_DDGI_RECEIVER_CACHE_COUNTER_BASE + 19u;
const uint SIMPLE_DDGI_RECEIVER_CACHE_COUNTER_COUNT = 20u;
