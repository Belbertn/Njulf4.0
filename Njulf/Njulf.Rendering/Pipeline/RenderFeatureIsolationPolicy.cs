    ...
    internal static class RenderFeatureIsolationPolicy
    {
        ...
        public static bool ShouldExecutePass(RenderFeatureIsolationMode mode, string passName)
        {
            ...
            return passName switch
            {
                ...
                "AmbientOcclusionPass" or "AmbientOcclusionBlurPass" or "SsgiTracePass" or "SsgiTemporalPass" or "SsgiDenoisePass" or "SsgiCompositePass" or "FarFieldClipmapBakePass" or "SimpleDdgiTracePass" or "SimpleDdgiBlendPass" or "DdgiSchedulePass" or "DdgiTracePass" or "DdgiBlendPass" or "DdgiRelocateClassifyPass" or "DdgiPublishPass" or "FogPass" or "AutoExposurePass" or "BloomPass" => AllowsPostProcessing(mode),
