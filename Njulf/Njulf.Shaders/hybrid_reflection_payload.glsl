...
const uint NJULF_HYBRID_REFLECTION_LOBE_BROAD_ANISOTROPIC = 1u << 1u;
const uint NJULF_HYBRID_REFLECTION_LOBE_MASK = 0x3u;
...
{
    return (payload.w >> 29u) & NJULF_HYBRID_REFLECTION_LOBE_MASK;
}
