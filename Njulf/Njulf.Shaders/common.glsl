...
const int DDGI_PROBE_VOLUME_BUFFER_INDEX = 142;
const int DDGI_PROBE_STATE_BUFFER_INDEX = 143;
const int DDGI_PROBE_UPDATE_QUEUE_BUFFER_INDEX = 144;
const int DDGI_PROBE_RELOCATION_CLASSIFICATION_BUFFER_INDEX = 145;
const int DDGI_IRRADIANCE_ATLAS_BUFFER_INDEX = 146;
const int DDGI_VISIBILITY_ATLAS_BUFFER_INDEX = 147;
const int DDGI_RAY_RESULT_SCRATCH_BUFFER_INDEX = 148;
const int DDGI_RAY_QUERY_INSTANCE_BUFFER_INDEX = 149;
const int DDGI_EMISSIVE_SOURCE_BUFFER_INDEX = 150;
const int DDGI_GATHER_TILE_BUFFER_INDEX = 151;
const int DDGI_SCHEDULER_CONSTANTS_BUFFER_INDEX = 152;
const int DDGI_DIRTY_REGION_BUFFER_INDEX = 153;
const int DDGI_PROBE_CANDIDATE_BUFFER_INDEX = 154;
const int DDGI_SCHEDULER_GROUP_COUNT_BUFFER_INDEX = 155;
const int DDGI_SCHEDULER_PREFIX_BUFFER_INDEX = 156;
const int DDGI_SCHEDULER_COUNTER_BUFFER_INDEX = 157;
const int DDGI_TRACE_INDIRECT_DISPATCH_BUFFER_INDEX = 158;
const int STATIC_BUFFER_COUNT = 159;
...
const int SIZEOF_GPU_SCENE_OPAQUE_COMPACTION_PUSH_CONSTANTS = 148;
...
const int SIZEOF_GPU_DDGI_PROBE_STATE = 80;
...
const int SIZEOF_GPU_DDGI_SCHEDULER_CONSTANTS = 128;
const int SIZEOF_GPU_DDGI_DIRTY_REGION = 32;
const int SIZEOF_GPU_DDGI_SCHEDULER_COUNTERS = 80;
...
const int OFFSET_GPU_DDGI_SCHEDULER_CONSTANTS_FRAME_INDEX = 24;
