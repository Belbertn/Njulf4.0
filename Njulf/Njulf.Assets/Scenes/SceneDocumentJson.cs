...
public static class SceneDocumentJson
{
    ...
    {
        "schemaVersion", "id", "name", "environment", "ambientLight", "importedModelLightsEnabled", "objects", "lights", "reflectionProbes",
    ...
    private static SceneDocument Normalize(SceneDocument document) => new()
    {
        ...
        ImportedDirectionalLightEnabled = document.ImportedDirectionalLightEnabled,
        ImportedModelLightShadowsEnabled = document.ImportedModelLightShadowsEnabled,
        ImportedLightOverrides = document.ImportedLightOverrides.OrderBy(item => item.Id).ToList(),
