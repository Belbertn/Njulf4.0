    ...
    IOpacityMicromapModelPayloadProducer
{
        ...
        out string detail)
    {
        ...
        TextureTransportSourceAnalysis decoded = TextureSourceDecoder.AnalyzeTransportSource(
            ktxBytes,
            TextureContainerKind.Ktx2,
            artifact.AbsoluteKtx2Path,
            new TextureDecodeOptions(ColorSpace: artifact.ColorSpace, ForceHdr: false, Semantic: TextureSemantic.Color),
