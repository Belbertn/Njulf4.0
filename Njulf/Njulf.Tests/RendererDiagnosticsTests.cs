    ...
    public class RendererDiagnosticsTests
    {
        ...
        public void Empty_HasZeroedPerformanceCounters()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(diagnostics.GpuGlobalSdfMicrosecondsRollingMax, Is.EqualTo(0));
                Assert.That(diagnostics.GpuGlobalSdfMicrosecondsRollingMaxFrameIndex, Is.EqualTo(-1));
                Assert.That(diagnostics.GpuGlobalSdfBrickMicrosecondsRollingMax, Is.EqualTo(0));
                Assert.That(diagnostics.GpuGlobalSdfBrickMicrosecondsRollingMaxFrameIndex, Is.EqualTo(-1));
                ...
                Assert.That(diagnostics.GlobalSdfBricksWrittenWithCandidatesLastNonzeroFrameIndex, Is.EqualTo(-1));
