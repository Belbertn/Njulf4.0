...
internal static class SceneDocumentCompatibility
{
        ...
        SceneDocument source)
    {
        ...
        return new SceneDocument
        {
            ...
            ImportedModelLightShadowsEnabled = source.ImportedModelLightShadowsEnabled,
            ImportedLightOverrides = source.ImportedLightOverrides.ToList(),
        ...
        SceneObjectDocument source)
    {
        ...
        return new SceneObjectDocument
        {
            ...
            TransformNodeId = source.TransformNodeId,
            ParentId = source.ParentId,
            PlacementRootId = source.PlacementRootId,
