...
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_TAIL_ADMIT = 5u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_ADMIT = 6u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_MATERIALIZE_CLASSIFY = 7u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_EMIT_PREFIX = 8u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_EMIT_SCATTER = 9u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_COMMIT = 10u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_FEEDBACK = 11u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_TRACE = 12u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_RELOCATE = 13u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_TRANSPORT = 14u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_BLEND = 15u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_PUBLISH = 16u;
const uint SIMPLE_DDGI_SCHEDULER_DISPATCH_COUNT = 17u;
