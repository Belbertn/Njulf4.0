...
namespace Njulf.Rendering.Resources
{
    ...
    /// <summary>
    /// Hard per-tier layout budget.  Persistent bytes include canonical atlas,
    /// sampled mirror reservation, state, queue, and classification storage;
    /// transient trace scratch is intentionally reported separately by runtime
    /// diagnostics because it is bounded by the scheduled update quota.
    /// </summary>
    ...
    public static class SimpleDdgiLayoutCompiler
    {
        ...
        public static ulong EstimatePersistentBytes(int probeCount, bool sampledAtlasRequested)
        {
            ...
            SimpleDdgiLayoutAdmissionMode admissionMode)
        {
            ...
            for (int index = 0; index < requests.Count; index++)
            {
                ...
                ulong persistentBytes = EstimatePersistentBytes(probes, sampledAtlasRequested);
