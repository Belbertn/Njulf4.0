...
const int GI_FINAL_DIFFUSE_TEXTURE_INDEX = 34;
const int LDR_SCENE_COLOR_TEXTURE_INDEX = 35;
const int SMAA_EDGES_TEXTURE_INDEX = 36;
const int SMAA_BLEND_WEIGHTS_TEXTURE_INDEX = 37;
const int SMAA_AREA_TEXTURE_INDEX = 38;
const int SMAA_SEARCH_TEXTURE_INDEX = 39;
const int MOTION_VECTOR_TEXTURE_INDEX = 40;
const int TAA_HISTORY_TEXTURE_INDEX = 41;
const int FOGGED_SCENE_COLOR_TEXTURE_INDEX = 42;
const int REFLECTION_PROBE_CUBEMAP_ARRAY_TEXTURE_INDEX = 43;
const int REFLECTION_PROBE_DEBUG_TEXTURE_INDEX = 44;
const int WEIGHTED_OIT_ACCUMULATION_TEXTURE_INDEX = 45;
const int WEIGHTED_OIT_REVEALAGE_TEXTURE_INDEX = 46;
const int FIRST_DYNAMIC_TEXTURE_INDEX = 47;
