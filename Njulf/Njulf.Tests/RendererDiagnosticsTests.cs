    ...
    public class RendererDiagnosticsTests
    {
        ...
        public void RenderSettings_DefaultsUseAcesHdrPipeline()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(settings.Bloom.MipCount, Is.EqualTo(4));
                ...
                Assert.That(settings.AmbientOcclusion.SampleCount, Is.EqualTo(8));
                ...
                Assert.That(settings.AntiAliasing.EffectiveMode, Is.EqualTo(AntiAliasingMode.Fxaa));
                Assert.That(settings.AntiAliasing.EffectiveSmaaQuality, Is.EqualTo(0));
                Assert.That(settings.AntiAliasing.EffectiveSmaaSpatialSampleCount, Is.EqualTo(0));
                Assert.That(settings.AntiAliasing.EffectiveSmaaUsesSpatialMultisampling, Is.False);
                ...
                Assert.That(settings.AntiAliasing.EffectiveSmaaThreshold, Is.EqualTo(0.0f));
                Assert.That(settings.AntiAliasing.EffectiveSmaaMaxSearchSteps, Is.EqualTo(0));
                Assert.That(settings.AntiAliasing.EffectiveSmaaMaxSearchStepsDiagonal, Is.EqualTo(0));
                Assert.That(settings.AntiAliasing.EffectiveSmaaCornerRounding, Is.EqualTo(0.0f));
                Assert.That(settings.AntiAliasing.EffectiveSmaaDiagonalEnabled, Is.False);
                Assert.That(settings.AntiAliasing.EffectiveSmaaCornerEnabled, Is.False);
