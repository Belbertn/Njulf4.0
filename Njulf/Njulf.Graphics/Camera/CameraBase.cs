...
{
    /// <summary>Mutable game-thread camera using Njulf math and row-vector view * projection transforms.</summary>
        public abstract class CameraBase : ICamera
    {
        ...
        /// <summary>World position in scene units.</summary>
        ...
        /// <summary>World-to-view transform using the framework row-vector convention.</summary>
        ...
        /// <summary>View-to-clip projection matrix.</summary>
        ...
        /// <summary>Combined view * projection transform.</summary>
        ...
        /// <summary>Near clipping distance in scene units; defaults to 0.1.</summary>
        ...
        /// <summary>Far clipping distance in scene units; defaults to 1000.</summary>
        ...
        /// <summary>Vertical field of view in radians; defaults to PI/3 (60 degrees).</summary>
        ...
        /// <summary>Viewport width divided by height; defaults to 16/9.</summary>
