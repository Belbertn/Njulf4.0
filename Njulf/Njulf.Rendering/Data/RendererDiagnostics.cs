...
namespace Njulf.Rendering.Data
{
        ...
        IReadOnlyList<SimpleDdgiTransportRingConvergenceTelemetry> Rings)
    {
        ...
        public IReadOnlyList<SimpleDdgiTransportAuditEvent> TailAuditLifecycleEvents { get; init; } =
            Array.Empty<SimpleDdgiTransportAuditEvent>();
        public ulong TailAuditLifecycleDroppedEventCount { get; init; }
        ...
        float MaxRayDistance)
    {
        ...
        /// <summary>Shared logical-to-physical toroidal mapping offset for this volume.</summary>
        public int PhysicalOffsetX { get; init; }
        public int PhysicalOffsetY { get; init; }
        public int PhysicalOffsetZ { get; init; }
        /// <summary>Receiver-aware authoring intent. Rings use TransitionSupport.</summary>
        public SimpleDdgiVolumePurpose IntendedPurpose { get; init; } = SimpleDdgiVolumePurpose.TransitionSupport;
        public int AuthoredPriority { get; init; }
        /// <summary>Pre-allocation layout admission outcome for this source volume.</summary>
        public SimpleDdgiLayoutDecision? LayoutDecision { get; init; }
        public string LayoutDecisionReason { get; init; } = string.Empty;
        public int LayoutRequestedProbeCount { get; init; }
        public int LayoutAcceptedProbeCount { get; init; }
        public ulong LayoutRequestedPersistentBytes { get; init; }
        public ulong LayoutAcceptedPersistentBytes { get; init; }
    }
        ...
        long GpuReflectionProbePublishMicroseconds)
    {
        ...
        /// <summary>Authored GI request before device fallback or the emergency rollback control is applied.</summary>
        ...
        /// <summary>Physical GI intensity before dynamic-path selection; retained for reproducible capture identity.</summary>
        public float GlobalIlluminationIndirectIntensity { get; init; }
        /// <summary>Bounded environment contribution used when GI support is unavailable.</summary>
        public float GlobalIlluminationEnvironmentFallbackIntensity { get; init; }
        ...
        /// <summary>
        /// Attribution of the legacy forward-GI timing field. Existing captures use an
        /// inclusive whole-forward-draw scope, so this value is diagnostic-only.
        /// </summary>
        public GiTimingAttribution GpuForwardGiGatherTimingAttribution { get; init; } = GiTimingAttribution.Unavailable;
        /// <summary>
        /// Direct isolated or deterministic paired-run forward-GI cost. Zero with
        /// <see cref="GpuForwardGiIncrementalAttribution"/> unavailable is intentionally not
        /// treated as a measured zero-cost path.
        /// </summary>
        public long GpuForwardGiIncrementalMicroseconds { get; init; }
        public GiTimingAttribution GpuForwardGiIncrementalAttribution { get; init; } = GiTimingAttribution.Unavailable;
        public string GpuForwardGiIncrementalTimingReason { get; init; } = "No isolated or paired forward-GI timing is available.";
        ...
        public uint DdgiTraceRingMismatchCorrectedCount { get; init; }
        public string DdgiTraceRingMismatchSample { get; init; } = string.Empty;
        ...
        public uint SimpleDdgiTransportEnergySampleCount { get; init; }
        public uint SimpleDdgiTransportSourceCacheHitCount { get; init; }
        public uint SimpleDdgiTransportSourceCacheMissCount { get; init; }
        ...
        public PerformanceCaptureRunMetadata CaptureRun { get; init; } = PerformanceCaptureRunMetadata.Unknown;
        public PerformanceCaptureCameraMetadata CaptureCamera { get; init; } = PerformanceCaptureCameraMetadata.Unknown;
        public PerformanceCaptureFrameMetadata CaptureFrame { get; init; } = PerformanceCaptureFrameMetadata.Unknown;
        ...
        /// <summary>Visible-first scheduler class/reservation/pressure evidence for this frame.</summary>
