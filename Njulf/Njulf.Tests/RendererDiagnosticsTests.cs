    ...
    public class RendererDiagnosticsTests
    {
        ...
        public void Empty_HasZeroedPerformanceCounters()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(diagnostics.AsyncComputeIndependentQueueAvailable, Is.EqualTo(0));
                Assert.That(diagnostics.AsyncComputeDedicatedQueueFamilyAvailable, Is.EqualTo(0));
                Assert.That(diagnostics.AsyncComputePlannedGraphicsSegmentCount, Is.EqualTo(0));
                Assert.That(diagnostics.AsyncComputeSubmittedGraphicsSegmentCount, Is.EqualTo(0));
                ...
                Assert.That(diagnostics.SimpleDdgiSampledAtlasRequested, Is.EqualTo(0));
                Assert.That(diagnostics.SimpleDdgiSampledAtlasActive, Is.EqualTo(0));
                Assert.That(diagnostics.SimpleDdgiSampledAtlasGroupCount, Is.EqualTo(0));
                Assert.That(diagnostics.SimpleDdgiSampledAtlasLayersPerTexture, Is.EqualTo(0));
                Assert.That(diagnostics.SimpleDdgiSampledAtlasImageBytes, Is.EqualTo(0));
                Assert.That(diagnostics.SimpleDdgiSampledAtlasFallbackReason, Is.EqualTo(string.Empty));
                ...
                Assert.That(diagnostics.DdgiAverageSpatialCoverageEstimate, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiAverageSupportCoverageEstimate, Is.EqualTo(0));
                ...
                Assert.That(diagnostics.CpuSimpleDdgiRecordMicroseconds, Is.EqualTo(0));
                Assert.That(diagnostics.CpuFarFieldRecordMicroseconds, Is.EqualTo(0));
                Assert.That(diagnostics.CpuGlobalIlluminationRecordMicroseconds, Is.EqualTo(0));
                Assert.That(diagnostics.CpuGlobalIlluminationRecordP95Microseconds, Is.EqualTo(0));
                Assert.That(diagnostics.GlobalIlluminationCpuTimingSampleCount, Is.EqualTo(0));
                ...
                Assert.That(diagnostics.DdgiGpuSchedulerCandidateBufferOverflowCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiGpuSchedulerPerBucketOverflowCount, Is.EqualTo(0));
                ...
                Assert.That(diagnostics.DdgiGpuSchedulerRequestBudgetRejectedCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiGpuSchedulerPrimaryRayBudgetRejectedCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiGpuSchedulerInvalidProbeCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiGpuSchedulerCandidateOutputCapacity, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiGpuSchedulerFullScan, Is.EqualTo(0));
                ...
                Assert.That(diagnostics.DdgiTraceDispatchGroupCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiTraceProbeCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiTraceRayCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiBlendProbeCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiRelocateClassifyProbeCount, Is.EqualTo(0));
                Assert.That(diagnostics.DdgiPublishProbeCount, Is.EqualTo(0));
        ...
        public void SceneRenderingData_ClearResetsDiagnosticsAndSnapshots()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(sceneData.CpuSimpleDdgiRecordMicroseconds, Is.EqualTo(0));
                Assert.That(sceneData.CpuFarFieldRecordMicroseconds, Is.EqualTo(0));
                Assert.That(sceneData.CpuGlobalIlluminationRecordMicroseconds, Is.EqualTo(0));
                Assert.That(sceneData.CpuGlobalIlluminationRecordP95Microseconds, Is.EqualTo(0));
                Assert.That(sceneData.GlobalIlluminationCpuTimingSampleCount, Is.EqualTo(0));
                ...
                Assert.That(sceneData.DdgiAverageSpatialCoverageEstimate, Is.EqualTo(0));
                Assert.That(sceneData.DdgiAverageSupportCoverageEstimate, Is.EqualTo(0));
                ...
                Assert.That(sceneData.DdgiGpuSchedulerCandidateBufferOverflowCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiGpuSchedulerPerBucketOverflowCount, Is.EqualTo(0));
                ...
                Assert.That(sceneData.DdgiGpuSchedulerRequestBudgetRejectedCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiGpuSchedulerPrimaryRayBudgetRejectedCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiGpuSchedulerInvalidProbeCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiGpuSchedulerCandidateOutputCapacity, Is.EqualTo(0));
                Assert.That(sceneData.DdgiGpuSchedulerFullScan, Is.EqualTo(0));
                ...
                Assert.That(sceneData.DdgiTraceDispatchGroupCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiTraceProbeCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiTraceRayCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiBlendProbeCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiRelocateClassifyProbeCount, Is.EqualTo(0));
                Assert.That(sceneData.DdgiPublishProbeCount, Is.EqualTo(0));
        ...
        public void RenderSettings_DefaultsUseDdgiProductionProfileAndAcesHdrPipeline()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(settings.GlobalIllumination.DdgiClipmapSafetyMarginCells, Is.EqualTo(4));
                Assert.That(settings.GlobalIllumination.DdgiFrustumPriorityWeight, Is.EqualTo(2.0f));
                Assert.That(settings.GlobalIllumination.DdgiOutOfFrustumMinimumUpdateFraction, Is.EqualTo(0.4f));
                Assert.That(settings.GlobalIllumination.DdgiNewProbeUpdateBoost, Is.EqualTo(4.0f));
                Assert.That(settings.GlobalIllumination.DdgiProbeUpdateTimeBudgetMilliseconds, Is.EqualTo(3.0f));
                Assert.That(settings.GlobalIllumination.DdgiGpuScheduleTimeBudgetMilliseconds, Is.EqualTo(0.25f));
                Assert.That(settings.GlobalIllumination.DdgiGpuTotalUpdateTimeBudgetMilliseconds, Is.EqualTo(3.0f));
                ...
                Assert.That(settings.GlobalIllumination.DdgiMaxProbeUpdatesPerFrame, Is.EqualTo(2048));
                ...
                Assert.That(settings.GlobalIllumination.DdgiGpuSchedulerSafetyScanFraction, Is.EqualTo(0.3f));
                ...
                Assert.That(settings.GlobalIllumination.DdgiProbeUpdatePrimaryRayBudget, Is.EqualTo(262144));
                Assert.That(settings.GlobalIllumination.DdgiColdStartMaxProbeUpdatesPerFrame, Is.EqualTo(2048));
                Assert.That(settings.GlobalIllumination.DdgiColdStartPrimaryRayBudget, Is.EqualTo(524288));
        ...
        public void RenderSettings_QualityPresetsApplyExpectedBudgets()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(settings.GlobalIllumination.DdgiCameraRelativeEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.DdgiProbeRelocationEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.DdgiMaxRaysPerProbe, Is.EqualTo(256));
                Assert.That(settings.GlobalIllumination.DdgiCascade0RaysPerProbe, Is.EqualTo(256));
        ...
        public void GlobalIlluminationSettings_DdgiQualityTiersAreMonotonic()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(high.DdgiClipmapCascadeCount, Is.EqualTo(4));
                ...
                Assert.That(high.DdgiClipmapBaseSpacing, Is.EqualTo(0.75f));
                Assert.That(high.DdgiCascade0VerticalCenterOffset, Is.EqualTo(-0.25f));
                Assert.That(high.DdgiCascade1VerticalCenterOffset, Is.EqualTo(2.5f));
                Assert.That(high.DdgiCascade2VerticalCenterOffset, Is.EqualTo(8.0f));
                Assert.That(high.DdgiCascade3VerticalCenterOffset, Is.EqualTo(16.0f));
                Assert.That(high.DdgiMaxActiveProbes, Is.EqualTo(32_256));
                Assert.That(high.DdgiMaxActiveProbes, Is.InRange(32_256, 32_256));
                Assert.That(ultra.DdgiMaxActiveProbes, Is.EqualTo(32_768));
                Assert.That(high.DdgiMaxProbeUpdatesPerFrame, Is.EqualTo(2048));
                Assert.That(high.DdgiProbeUpdatePrimaryRayBudget, Is.EqualTo(262144));
                Assert.That(high.DdgiMaxRaysPerProbe, Is.EqualTo(128));
                Assert.That(high.DdgiProbeUpdateTimeBudgetMilliseconds, Is.EqualTo(3.0f));
                Assert.That(high.DdgiGpuScheduleTimeBudgetMilliseconds, Is.EqualTo(0.25f));
                Assert.That(high.DdgiGpuTotalUpdateTimeBudgetMilliseconds, Is.EqualTo(3.0f));
                Assert.That(low.SimpleDdgiRingCount, Is.LessThanOrEqualTo(medium.SimpleDdgiRingCount));
                Assert.That(medium.SimpleDdgiRingCount, Is.LessThanOrEqualTo(high.SimpleDdgiRingCount));
                Assert.That(high.SimpleDdgiRingCount, Is.LessThanOrEqualTo(ultra.SimpleDdgiRingCount));
                Assert.That(low.SimpleDdgiRingGridSizeX, Is.LessThan(medium.SimpleDdgiRingGridSizeX));
                Assert.That(medium.SimpleDdgiRingGridSizeX, Is.LessThan(high.SimpleDdgiRingGridSizeX));
                Assert.That(high.SimpleDdgiRingGridSizeX, Is.LessThan(ultra.SimpleDdgiRingGridSizeX));
                Assert.That(low.SimpleDdgiRingGridSizeY, Is.LessThan(medium.SimpleDdgiRingGridSizeY));
                Assert.That(medium.SimpleDdgiRingGridSizeY, Is.LessThan(high.SimpleDdgiRingGridSizeY));
                Assert.That(high.SimpleDdgiRingGridSizeY, Is.LessThan(ultra.SimpleDdgiRingGridSizeY));
                Assert.That(low.SimpleDdgiRaysPerProbe, Is.LessThan(medium.SimpleDdgiRaysPerProbe));
                Assert.That(medium.SimpleDdgiRaysPerProbe, Is.LessThan(high.SimpleDdgiRaysPerProbe));
                Assert.That(high.SimpleDdgiRaysPerProbe, Is.LessThan(ultra.SimpleDdgiRaysPerProbe));
                Assert.That(low.SimpleDdgiProbeUpdatesPerFrame, Is.LessThan(medium.SimpleDdgiProbeUpdatesPerFrame));
                Assert.That(medium.SimpleDdgiProbeUpdatesPerFrame, Is.LessThan(high.SimpleDdgiProbeUpdatesPerFrame));
                Assert.That(high.SimpleDdgiProbeUpdatesPerFrame, Is.LessThan(ultra.SimpleDdgiProbeUpdatesPerFrame));
                Assert.That(low.FarFieldClipmapResolution, Is.LessThan(medium.FarFieldClipmapResolution));
                Assert.That(medium.FarFieldClipmapResolution, Is.LessThan(high.FarFieldClipmapResolution));
                ...
                Assert.That(low.SimpleDdgiReducedBlendEnabled, Is.True);
                Assert.That(medium.SimpleDdgiReducedBlendEnabled, Is.True);
                Assert.That(high.SimpleDdgiReducedBlendEnabled, Is.False);
                Assert.That(ultra.SimpleDdgiReducedBlendEnabled, Is.False);
        ...
        [Test]
        public void GlobalIlluminationSettings_DefaultsToSimpleDdgiWithoutSsgi()
        {
            var settings = new GlobalIlluminationSettings();

            Assert.Multiple(() =>
            {
                Assert.That(settings.UseSsgi, Is.False);
                Assert.That(settings.EffectiveUseSsgi, Is.False);
                Assert.That(settings.UseDdgi, Is.True);
        ...
        public void RenderSettings_SaveLoadRoundTripsShippingOptions()
        {
            ...
            try
            {
                ...
                settings.GlobalIllumination.DdgiCascade0VerticalCenterOffset = -0.5f;
                settings.GlobalIllumination.DdgiCascade1VerticalCenterOffset = 3.0f;
                settings.GlobalIllumination.DdgiCascade2VerticalCenterOffset = 9.0f;
                settings.GlobalIllumination.DdgiCascade3VerticalCenterOffset = 18.0f;
                ...
                settings.GlobalIllumination.SimpleDdgiSharedMemoryBlendEnabled = false;
                settings.GlobalIllumination.SimpleDdgiClassificationSchedulingEnabled = false;
                settings.GlobalIllumination.SimpleDdgiClassificationReadbackEnabled = false;
                settings.GlobalIllumination.SimpleDdgiAdaptiveHysteresisEnabled = false;
                settings.GlobalIllumination.SimpleDdgiLightingDirtyBoostEnabled = false;
                settings.GlobalIllumination.SimpleDdgiDynamicGeometryDirtyBoostEnabled = false;
                settings.GlobalIllumination.SimpleDdgiAdaptiveRaysEnabled = false;
                ...
                settings.GlobalIllumination.SimpleDdgiMaintenanceRaysPerProbe = 24;
                settings.GlobalIllumination.SimpleDdgiHysteresisChangeThreshold = 0.20f;
                settings.GlobalIllumination.SimpleDdgiHysteresisStepThreshold = 0.70f;
                settings.GlobalIllumination.SimpleDdgiLightingDirtyFrameCount = 45;
                settings.GlobalIllumination.SimpleDdgiStableMaintenanceUpdateCount = 5;
                settings.GlobalIllumination.SimpleDdgiStableMaintenanceEmaThreshold = 0.04f;
                ...
                Assert.Multiple(() =>
                {
                    ...
                    Assert.That(loaded.GlobalIllumination.DdgiCascade0VerticalCenterOffset, Is.EqualTo(-0.5f));
                    Assert.That(loaded.GlobalIllumination.DdgiCascade1VerticalCenterOffset, Is.EqualTo(3.0f));
                    Assert.That(loaded.GlobalIllumination.DdgiCascade2VerticalCenterOffset, Is.EqualTo(9.0f));
                    Assert.That(loaded.GlobalIllumination.DdgiCascade3VerticalCenterOffset, Is.EqualTo(18.0f));
                    ...
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiSharedMemoryBlendEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiClassificationSchedulingEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiClassificationReadbackEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiAdaptiveHysteresisEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiLightingDirtyBoostEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiDynamicGeometryDirtyBoostEnabled, Is.False);
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiAdaptiveRaysEnabled, Is.False);
                    ...
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiMaintenanceRaysPerProbe, Is.EqualTo(24));
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiHysteresisChangeThreshold, Is.EqualTo(0.20f));
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiHysteresisStepThreshold, Is.EqualTo(0.70f));
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiLightingDirtyFrameCount, Is.EqualTo(45));
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiStableMaintenanceUpdateCount, Is.EqualTo(5));
                    Assert.That(loaded.GlobalIllumination.SimpleDdgiStableMaintenanceEmaThreshold, Is.EqualTo(0.04f));
        ...
        [Test]
        public void AsyncComputeSettings_DefaultAutoWithDdgiFocusedCandidateToggles()
        {
            var settings = new RenderSettings();
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(settings.AsyncCompute.FullDdgiUpdateEnabled, Is.True);
                Assert.That(settings.AsyncCompute.FarFieldClipmapBakeEnabled, Is.True);
                Assert.That(settings.AsyncCompute.SsgiChainEnabled, Is.False);
                Assert.That(settings.GlobalIllumination.UseSsgi, Is.False);
                Assert.That(settings.GlobalIllumination.EffectiveUseSsgi, Is.False);
                Assert.That(settings.GlobalIllumination.UseDdgi, Is.True);
                Assert.That(settings.GlobalIllumination.SimpleDdgiSharedMemoryBlendEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.SimpleDdgiClassificationSchedulingEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.SimpleDdgiClassificationReadbackEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.SimpleDdgiAdaptiveHysteresisEnabled, Is.True);
                Assert.That(settings.GlobalIllumination.SimpleDdgiLightingDirtyBoostEnabled, Is.True);
                ...
                Assert.That(settings.GlobalIllumination.SimpleDdgiMaintenanceRaysPerProbe, Is.EqualTo(32));
        ...
        public void GlobalIlluminationSettings_ClampToSupportedRanges()
        {
            var settings = new GlobalIlluminationSettings
            {
                ...
                DdgiCascade0VerticalCenterOffset = 999f,
                DdgiCascade1VerticalCenterOffset = 999f,
                DdgiCascade2VerticalCenterOffset = 999f,
                DdgiCascade3VerticalCenterOffset = 999f,
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(settings.DdgiProbeRelocationEnabled, Is.True);
                ...
                Assert.That(settings.DdgiCascade0VerticalCenterOffset, Is.EqualTo(64.0f));
                Assert.That(settings.DdgiCascade1VerticalCenterOffset, Is.EqualTo(64.0f));
                Assert.That(settings.DdgiCascade2VerticalCenterOffset, Is.EqualTo(64.0f));
                Assert.That(settings.DdgiCascade3VerticalCenterOffset, Is.EqualTo(64.0f));
            ...
            settings.DdgiCascade0VerticalCenterOffset = -999f;
            settings.DdgiCascade1VerticalCenterOffset = -999f;
            settings.DdgiCascade2VerticalCenterOffset = -999f;
            settings.DdgiCascade3VerticalCenterOffset = -999f;
        ...
        public void GlobalIlluminationRenderTargetBytes_FollowEffectiveSsgiMode()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(ddgiOnly.EffectiveUseSimpleDdgi, Is.True);
                Assert.That(ddgiOnly.EffectiveUseDdgi, Is.False);
                ...
                Assert.That(hybrid.EffectiveUseSimpleDdgi, Is.True);
                Assert.That(hybrid.EffectiveUseDdgi, Is.False);
