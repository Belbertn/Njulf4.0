...
#define DDGI_LIGHT_TREE_NODE_MALFORMED_RANGE_BIT (1u << 1u)
#define DDGI_LIGHT_TREE_NODE_SPOT_LIGHT_BIT (1u << 2u)
#define DDGI_LIGHT_TREE_NODE_INVALID_BOUND_BIT (1u << 3u)
#define DDGI_LIGHT_TREE_NODE_AREA_LIGHT_BIT (1u << 4u)
#define DDGI_LIGHT_TREE_NODE_PROPAGATED_BITS \
    (DDGI_LIGHT_TREE_NODE_MALFORMED_RANGE_BIT | \
     DDGI_LIGHT_TREE_NODE_SPOT_LIGHT_BIT | \
     DDGI_LIGHT_TREE_NODE_INVALID_BOUND_BIT | \
     DDGI_LIGHT_TREE_NODE_AREA_LIGHT_BIT)
#define DDGI_LIGHT_BUFFER_STATE_WORD_OFFSET (1024u * 28u)
