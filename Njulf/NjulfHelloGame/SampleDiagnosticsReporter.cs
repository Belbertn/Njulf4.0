...
internal sealed class SampleDiagnosticsReporter
{
    ...
    private static void PrintDdgiTriageDiagnostics(RendererDiagnostics diagnostics)
    {
        ...
        Console.WriteLine(
            ...
            $"sdfBricks={diagnostics.GlobalSdfBricksUpdated} priority/dirty/idleRefreshExecuted={diagnostics.GlobalSdfPriorityBricksUpdated}/{diagnostics.GlobalSdfDirtyBricksUpdated}/{diagnostics.GlobalSdfIdleRefreshBricksUpdated} (budget={diagnostics.GlobalSdfBrickUpdateBudget} backlog before/after={diagnostics.GlobalSdfDirtyBrickBacklogBefore}/{diagnostics.GlobalSdfDirtyBrickBacklogAfter}) meshSdfs={diagnostics.GlobalSdfMeshSdfCount} overflow={diagnostics.GlobalSdfCandidateOverflowCount} emptyPrevCandidateBricks={diagnostics.GlobalSdfEmptyPreviouslyCandidateBrickCount} sdfSteps={diagnostics.GlobalSdfAverageTraceSteps:F2} sdfTraces={diagnostics.DdgiSdfTraceCount} rayQueryTraces={diagnostics.DdgiRayQueryTraceCount} " +
            $"sdfInsideStarts={diagnostics.DdgiSdfInsideStartCount} sdfBackfaceSynthesized={diagnostics.DdgiSdfBackfaceSynthesizedCount} sdfStepExhausted={diagnostics.DdgiSdfStepExhaustedCount} sdfCoarseSkips={diagnostics.DdgiSdfCoarseSkipCount} " +
