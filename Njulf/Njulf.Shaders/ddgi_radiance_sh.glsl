...
const uint SIMPLE_DDGI_GLOSSY_TRANSPORT_MODE_RECURSIVE_CERTIFIED = 3u;
// Compatibility alias for already-compiled captures and shader-contract tests.
const uint SIMPLE_DDGI_GLOSSY_TRANSPORT_MODE_RECURSIVE_EXPERIMENTAL =
