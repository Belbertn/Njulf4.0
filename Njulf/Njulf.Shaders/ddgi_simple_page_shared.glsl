...
const uint SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_BOOTSTRAP = 1u << 1u;
const uint SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_DEMAND_CLASS_SHIFT = 8u;
const uint SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_DEMAND_CLASS_MASK =
    0xffu << SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_DEMAND_CLASS_SHIFT;
const uint SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_VALID_PROBE_COUNT_SHIFT = 16u;
const uint SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_VALID_PROBE_COUNT_MASK =
    0xffu << SIMPLE_DDGI_PHYSICAL_PAGE_ALLOCATION_VALID_PROBE_COUNT_SHIFT;
