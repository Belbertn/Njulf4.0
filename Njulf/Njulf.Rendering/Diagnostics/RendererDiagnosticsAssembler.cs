...
internal sealed class RendererDiagnosticsAssembler
{
        ...
        in RendererDiagnosticsAssemblyInput input)
    {
            ...
            GpuReflectionProbePublishMicroseconds: sceneData.GpuReflectionProbePublishMicroseconds)
        {
            ...
            OpticalReducedResolutionShadingActive = sceneData.OpticalReducedResolutionShadingActive,
            OpticalShadingReflectionRequests = sceneData.OpticalShadingReflectionRequests,
            OpticalShadingTransmissionTasks = sceneData.OpticalShadingTransmissionTasks,
            ThickTransmissionRequestedTasks = sceneData.ThickTransmissionRequestedTasks,
            ...
            DenoisingStageMicroseconds = sceneData.DenoisingStageMicroseconds,
            DenoisingDispatchCounts = new System.Collections.Generic.Dictionary<string, int>(sceneData.DenoisingDispatchCounts),
            AmdReflectionDenoisingActive = sceneData.AmdReflectionDenoisingActive,
            AmdReflectionDenoisingHalfResolution = sceneData.AmdReflectionDenoisingHalfResolution,
            AmdReflectionFilterWidth = sceneData.AmdReflectionFilterWidth,
            AmdReflectionFilterHeight = sceneData.AmdReflectionFilterHeight,
            AmdReflectionDispatchedPixels = sceneData.AmdReflectionDispatchedPixels,
