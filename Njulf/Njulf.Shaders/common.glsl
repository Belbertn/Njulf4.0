...
const int DIRECTIONAL_STATIC_SHADOW_MESHLET_DRAW_BUFFER_BASE_INDEX = 64;
const int DIRECTIONAL_STATIC_SHADOW_MESHLET_DRAW_BUFFER_FRAME1_INDEX = 65;
const int DIRECTIONAL_DYNAMIC_SHADOW_MESHLET_DRAW_BUFFER_BASE_INDEX = 66;
const int DIRECTIONAL_DYNAMIC_SHADOW_MESHLET_DRAW_BUFFER_FRAME1_INDEX = 67;
const int LOCAL_STATIC_SHADOW_MESHLET_DRAW_BUFFER_BASE_INDEX = 68;
...
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE0_BUFFER_BASE_INDEX = 116;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE0_BUFFER_FRAME1_INDEX = 117;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE1_BUFFER_BASE_INDEX = 118;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE1_BUFFER_FRAME1_INDEX = 119;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE2_BUFFER_BASE_INDEX = 120;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE2_BUFFER_FRAME1_INDEX = 121;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE3_BUFFER_BASE_INDEX = 122;
const int SCENE_DIRECTIONAL_STATIC_SHADOW_COMPACTED_CASCADE3_BUFFER_FRAME1_INDEX = 123;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE0_BUFFER_BASE_INDEX = 124;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE0_BUFFER_FRAME1_INDEX = 125;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE1_BUFFER_BASE_INDEX = 126;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE1_BUFFER_FRAME1_INDEX = 127;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE2_BUFFER_BASE_INDEX = 128;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE2_BUFFER_FRAME1_INDEX = 129;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE3_BUFFER_BASE_INDEX = 130;
const int SCENE_DIRECTIONAL_DYNAMIC_SHADOW_COMPACTED_CASCADE3_BUFFER_FRAME1_INDEX = 131;
const int STATIC_BUFFER_COUNT = 132;
...
const int WEIGHTED_OIT_ACCUMULATION_TEXTURE_INDEX = 37;
const int WEIGHTED_OIT_REVEALAGE_TEXTURE_INDEX = 38;
