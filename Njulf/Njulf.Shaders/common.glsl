...
const int FAR_FIELD_CLIPMAP_PARAMS_BUFFER_INDEX = 176;
const int FAR_FIELD_CLIPMAP_VOXEL_BUFFER_INDEX = 177;
const int FAR_FIELD_CLIPMAP_INSTANCE_BUFFER_INDEX = 178;
const int FAR_FIELD_CLIPMAP_BAKE_VOXEL_BUFFER_INDEX = 179;
const int FAR_FIELD_CLIPMAP_DISTANCE_BUFFER_INDEX = 180;
const int FAR_FIELD_CLIPMAP_JUMP_FLOOD_SCRATCH0_BUFFER_INDEX = 181;
const int FAR_FIELD_CLIPMAP_JUMP_FLOOD_SCRATCH1_BUFFER_INDEX = 182;
const int FAR_FIELD_CLIPMAP_PAGE_TABLE_BUFFER_INDEX = 183;
const int STATIC_BUFFER_COUNT = 184;
...
const int SIZEOF_GPU_SCENE_OPAQUE_COMPACTION_PUSH_CONSTANTS = 152;
